...
function createSupplementaryPoints(
  ...
  options: {
    midpoints?: boolean;
    selectedPaths?: (typeof basePath)[];
  } = {},
  basePath: null | string = null
) {
  ...
  function processLine(line, lineBasePath: typeof basePath) {
  ...
  function isSelectedPath(path: typeof basePath) {
